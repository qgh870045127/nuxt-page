<template>
  <div class="news wc">
    ...
    >
      <div class="bright-button" style="opacity: 0" v-lazyBox="{ delay: 0.3 }">
        测试
      </div>
      <div class="bright-button" style="opacity: 0" v-lazyBox="{ delay: 0.4 }">
        测试
      </div>
      <div class="bright-button" style="opacity: 0" v-lazyBox="{ delay: 0.5 }">
        测试
      </div>
      <div class="bright-button" style="opacity: 0" v-lazyBox="{ delay: 0.6 }">
        测试
      </div>
    </div>
  </div>
